...
class Wire(object):
    ...
    def get_size(self, cell):
        ...
        for site_i in cell.sites:
            ...
            non_periodic_site_i = Site(site_i.species, [site_i.coords[0], site_i.coords[1], 0.0])
            for site_j in cell.sites:
                #non_periodic_site_j = Site(site_j.species_and_occu, [site_j.coords[0], site_j.coords[1], 0.0])
                non_periodic_site_j = Site(site_j.species, [site_j.coords[0], site_j.coords[1], 0.0])
...
class Cluster(object):
    ...
    def get_size(self, cell):
        ...
        for site_i in cell.sites:
            ...
            non_periodic_site_i = Site(site_i.species, site_i.coords)
            for site_j in cell.sites:
                #non_periodic_site_j = Site(site_j.species_and_occu, site_j.coords)
                non_periodic_site_j = Site(site_j.species, site_j.coords)
                distance = non_periodic_site_i.distance(non_periodic_site_j)
                if distance > max_distance:
                    max_distance = distance
        return max_distance
