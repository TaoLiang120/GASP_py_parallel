...
def print_parameters(objects_dict, garun_dir):
    """
    ...
    with open(garun_dir + '/ga_parameters', 'w') as parameters_file:
        ...
        parameters_file.write('RunTitle: ' + run_title +
                              '\n')
        parameters_file.write('Screen: ' + str(objects_dict['Screen']) +
                              '\n')
        parameters_file.write('Log: ' + str(objects_dict['Log']) +
                              '\n')
        ...
        if energy_calculator.name == 'gulp':
            parameters_file.write('        path_to_callscript: ' +
                                  energy_calculator.path_to_callscript + '\n')
            parameters_file.write('        callscript: ' +
                                  energy_calculator.callscript + '\n')
        ...
        elif energy_calculator.name == 'pylammps':
            parameters_file.write('        input_script: ' +
                                  energy_calculator.input_script + '\n')
        ...
        parameters_file.write('NumCalcsAtOnce: ' + str(num_calcs_at_once) +
                              '\n')
        parameters_file.write('NumProcTask: ' + str(nproc_task) +
                              '\n')
        parameters_file.write('NumCalcsRestartFile: ' + str(objects_dict['num_calcs_to_restartfile']) +
                              '\n')
        ...
        parameters_file.write('    num_promoted: ' + str(pool.num_promoted) +
                              '\n')
        parameters_file.write('    interval_to_print: ' + str(pool.interval_to_print) +
                              '\n')
        parameters_file.write('\n')
